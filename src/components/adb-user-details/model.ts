...
export const UserDetailsSchema = Yup.object().shape({
  ...
  religion: Yup.string().trim().required('this field is required'),
  maritalStatus: Yup.string().trim().required('this field is required'),
  line1: Yup.string().trim().required('this field is required'),
  postcode: Yup.string().trim().required('this field is required'),
  city: Yup.string().trim().required('this field is required'),
  state: Yup.string().trim().required('this field is required'),
  employmentType: Yup.string().trim().required('this field is required'),
  employmentSector: Yup.string().trim().required('this field is required'),
  employerName: Yup.string().trim().required('this field is required'),
  occupation: Yup.string().trim().required('this field is required'),
  annualIncome: Yup.string().trim().required('this field is required'),
});
