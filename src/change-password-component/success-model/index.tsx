    ...
    <View style={styles.containerStyle}>
      <View style={styles.mainContainerStyle}>
        ...
        <Text style={styles.titleTextStyle}>
          {i18n?.t('change_password.lbl_success_title') ?? 'Success!'}
        </Text>
        <Text style={styles.messageTextStyle}>
          {i18n?.t('change_password.msg_success') ?? 'Your password was successfully updated!'}
        </Text>
      </View>
      <View style={styles.footerContainerStyle}>
        <Button
          label={i18n?.t('change_password.btn_success_next') ?? 'Proceed to dashboard'}
          onPress={onNext}
        />
      </View>
    </View>
